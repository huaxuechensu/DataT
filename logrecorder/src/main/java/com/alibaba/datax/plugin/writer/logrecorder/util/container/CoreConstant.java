package com.alibaba.datax.plugin.writer.logrecorder.util.container;
...
public class CoreConstant {
	...
	public static String DATAX_LOG2DB_PATH = StringUtils.join(new String[] {
			DATAX_HOME, "conf", "log2DB.json" }, File.separator);
